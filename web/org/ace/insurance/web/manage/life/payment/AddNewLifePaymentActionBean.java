...
public class AddNewLifePaymentActionBean extends BaseBean implements Serializable {
	...
	public void selectUser() {
		...
		WorkFlowType workFlowType = isPersonalAccident ? WorkFlowType.PERSONAL_ACCIDENT : isFarmer ? WorkFlowType.FARMER :isSeamanLife ? WorkFlowType.SEAMEN : WorkFlowType.LIFE;
													...
													: isGroupLife ? ReferenceType.GROUP_LIFE
														: isEndownmentLife ? ReferenceType.ENDOWMENT_LIFE
																: isPublicTermLife ? ReferenceType.PUBLIC_TERM_LIFE 
																		:isSeamanLife ? ReferenceType.SEAMEN_LIFE : ReferenceType.SPORT_MAN;
