	...
	private class ExportExcel {
		...
		public void generate2(OutputStream op) {
			try {
				...
				cell = row.createCell(0);
				cell.setCellValue(MyanmarLanguae.getMyanmarLanguaeString("CRITICAL_MONTHLY_REPORTH_HEADER-002") + " " + DateUtils.getDateFormatString(new Date()));
				cell.setCellStyle(centerCellStyle);

				row = sheet1.createRow(4);
				cell = row.createCell(0);
				cell.setCellValue(MyanmarLanguae.getMyanmarLanguaeString("CRITICAL_MONTHLY_REPORTH_HEADER_001"));
				cell.setCellStyle(centerCellStyle);
				...
				for (CriticalIBRBMonthlyReport criticalIllnessIBRBReport : criticalIllnessIBRBReportList) {
					...
					cell.setCellValue(criticalIllnessIBRBReport.getAgentName() == null || criticalIllnessIBRBReport.getLiscenseno() == null ? "NA[-]"
							: criticalIllnessIBRBReport.getAgentName() + " \n [" + criticalIllnessIBRBReport.getLiscenseno() + "]");
					cell.setCellStyle(defaultCellStyle);

					// Agent Commission
					cell = row.createCell(21);
					cell.setCellValue(criticalIllnessIBRBReport.getAgentcommission());
					cell.setCellStyle(defaultCellStyle);

					// salesPoint
					/*
					 * cell = row.createCell(22);
					 * cell.setCellValue(criticalIllnessIBRBReport.getSalesPointName());
					 * cell.setCellStyle(defaultCellStyle);
					 */
					// date
					cell = row.createCell(22);
					cell.setCellValue(criticalIllnessIBRBReport.getFromDatetoDate());
					cell.setCellStyle(defaultCellStyle);

					// term
					cell = row.createCell(23);
					cell.setCellValue(criticalIllnessIBRBReport.getFromTermtoTerm());
					cell.setCellStyle(defaultCellStyle);
					
					cell = row.createCell(24);
					cell.setCellValue(criticalIllnessIBRBReport.getSaleChannelType().toString());
					cell.setCellStyle(defaultCellStyle);
				...
				cell = row.createCell(21);
				cell.setCellStyle(currencyCellStyle);
				premiumFormula = "SUM(V9:V" + i + ")";
				cell.setCellType(XSSFCell.CELL_TYPE_FORMULA);
				cell.setCellFormula(premiumFormula);

				wb.setPrintArea(0, 0, 25, 0, i);
