...
public class HealthDailyPremiumReportDTO {
	...
	public HealthDailyPremiumReportDTO(String policyNo, String cashReceiptNo, String insuredPersonName, String organizationName, Date paymentDate, String branchId,
			String branchName, double netPremium, String toTerm, String paymentType, int personsCount) {
