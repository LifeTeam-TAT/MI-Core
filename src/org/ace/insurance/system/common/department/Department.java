...
@NamedQueries(value = { @NamedQuery(name = "Department.findAll", query = "SELECT o FROM Department o ORDER BY o.name ASC"),
		@NamedQuery(name = "Department.findById", query = "SELECT o FROM Department o WHERE o.id = :id") })
